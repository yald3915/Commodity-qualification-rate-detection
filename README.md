This file is the baseline code for Practice your ML skills on this approachable dataset!

以上文件是Practice your ML skills on this approachable dataset!（商品合格率检测）基于大规模预训练模型的风险事件标签识别）比赛的baseline代码
